        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <p className="font-serif text-blue-500 text-lg font-medium">You deploy way more than you think</p>
              <h1 className="font-sans text-5xl md:text-7xl font-bold text-gray-900 leading-tight">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="font-serif text-blue-400 text-lg">Try Workflow on your next project today.</p>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                size="lg"
                className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 text-lg font-medium rounded-xl shadow-lg"
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="bg-gray-800 hover:bg-gray-900 text-white border-gray-800 px-8 py-4 text-lg font-medium rounded-xl shadow-lg"
              >
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
